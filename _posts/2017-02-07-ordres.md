...
ordres partiels, on appelle cette propriété être un *[treillis](https://fr.wikipedia.org/wiki/Treillis_(ensemble_ordonn%C3%A9))*.
...
pouvez-vous donner une méthdoe de calcul générique qui vous donne le résultat ? 
La réponse et la démonstration associée se trouve dans l'article [The weak order on integer posets](https://arxiv.org/abs/1701.07995)
